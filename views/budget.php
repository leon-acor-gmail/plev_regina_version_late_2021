...
<script>
    ...
    $(document).ready(function(){
            ...
            objResources.setHTML('<?php echo($_SESSION['spr']); ?>','<?php echo($_GET['token']); ?>','<?php echo($_SESSION['nme']); ?>',$('#divHeader'),$('#divFooter'), $('#divBreadcrumbs'), JSON.stringify([{'s':'home.php', 'n': 'inicio'},{'s':'#', 'n': 'presupuesto'}, {'s':'#', 'n': 'cuenta del proyecto'}]));
        });
</script>
<header class="w3-top">
...
<section class="divMiddle">
    <label>Reporte de presupuesto</label>
</section>
